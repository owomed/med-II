...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('yarim-bilet')
        .setDescription('Belirtilen kullanıcıya Yarım Bilet rolü verir veya alır.')
    ...
    async runCommand(client, interactionOrMessage, authorMember, targetMember) {
        ...
        if (targetMember.roles.cache.has(roleToCheck)) {
            ...
            embed.setDescription(`${targetMember} adlı kullanıcıdan ${role} rolü alındı. <a:med_verify2:1242796273480892428>`);
        } else {
            ...
            embed.setDescription(`${targetMember} adlı kullanıcıya ${role} rolü verildi. <a:med_verify2:1242796273480892428>`);
        }
